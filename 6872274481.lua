...
local function runAzunity(func) func() end
local function runRender(func) func() end
local function runLua(func) func() end
local function runVape(func) func() end
local function runClient(func) func() end
local function runPiston(func) func() end
local function runSkid(func) func() end
...
Aquari = GuiLibrary.ObjectsThatCanBeSaved.WorldWindow.Api.CreateOptionsButton({
    Name = "Aquari Pack",
    Function = function(callback)
        if callback then
...
runAzunity(function()
	...
	overlayframe.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	overlayframe.Size = UDim2.new(0, 200, 0, 50)
	...
	overlayframe2.Size = UDim2.new(0, 0, 0, 0)
	overlayframe2.Position = UDim2.new(0, 0, 0, -5)
	overlayframe2.Parent = overlayframe
	local overlayframe3 = Instance.new("Frame")
	overlayframe3.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
	overlayframe3.Size = UDim2.new(1, 0, 0, 2)
	...
	framecorner1.CornerRadius = UDim.new(0, 8.3)
...
local Messages = {
    "Azunity Private cracked fr",
    "azunity Private on top",
    "Skill issue?",
    "gayclient + coldware = gay",
    "AC mods are shit ngl",
    "AC mods gave up lmao",
    "fanware stop skidding Lmfao"
}
local old
                                ...
                                function()
                                    pcall(
                                        function()
                                            ...
                                            obj.Parent.TextColor3 = Color3.new(1, 1, 1)
                                        end
                                    )
                                end
                            )
...
runAzunity(function()
    ...
    local InfiniteJump = GuiLibrary.ObjectsThatCanBeSaved.BlatantWindow.Api.CreateOptionsButton({
        Name = "InfiniteJump",
        Function = function(callback)
            infiniteJumpEnabled = callback
